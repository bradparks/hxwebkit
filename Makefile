...
LIBS = -Iinclude -I/usr/include -I/usr/lib/neko/include -I/usr/include/gtk-3.0
NDLL = ndll/$(OS)/webkit.ndll

OBJS = src/util.o src/gtk.o src/hxwebkit.o src/javascript.o src/plugin_test.o
...
.PHONY: ndll install uninstall tests tests-run cpp clean all
